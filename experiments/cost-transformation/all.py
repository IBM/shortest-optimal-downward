...
algs2 = []
for nick in nicks:
    algs2.extend(["ct-%s" % nick, "wct-%s" % nick])
...
exp.add_absolute_report_step(attributes=['coverage'], filter=rename_algorithms, filter_algorithm=algs2, filter_domain=NEW_SUITE, format="tex")
