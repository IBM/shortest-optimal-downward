...
CONFIGS = [
    ...
    IssueConfig("ct-blind", ["--search", "astar(blind(),verbosity=silent)"]),
    IssueConfig("ct-lmcut", ["--search", "astar(lmcut(),verbosity=silent)"]),
    ...
    IssueConfig("ct-cegar", ["--search", "astar(cegar(),verbosity=silent)"]),
    IssueConfig("ct-hmax", ["--search", "astar(hmax(),verbosity=silent)"]),
    IssueConfig("ct-ipdb", ["--search", "astar(ipdb(pdb_max_size=2000000, collection_max_size=20000000, num_samples=1000, min_improvement=10, max_time=infinity, random_seed=-1, max_time_dominance_pruning=infinity, transform=no_transform(), cache_estimates=true),verbosity=silent)"]),
]
